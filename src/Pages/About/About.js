...
const About = () => {
	...
	<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
     ...
     data-aos-duration="1000">
			...
			<p className="dark:text-gray-400">I am a person who is positive about every aspect of life.Currently, I studied at the department of "Computer science and Engineering" at North East University Bangladesh, Sylhet.I am passionate about programming.Everyday I learn new technologies for updated myself in this tech world.
